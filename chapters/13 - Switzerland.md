...
1. **Federal Council (Bund).** *Informationssicherheitsgesetz (ISG)*. ([pdf][1])

2. **Federal Council (Bund).** *Cybersicherheitsverordnung (CSV)*. ([Fedlex][2])


[1]: https://www.newsd.admin.ch/newsd/message/attachments/69892.pdf "Informationssicherheitsgesetz (ISG)"

[2]: https://www.fedlex.admin.ch/eli/cc/2025/169/de "Cybersicherheitsverordnung (CSV)"
