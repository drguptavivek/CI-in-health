...
*(Only what is supported by sources actually opened: online primary sources + your PDFs. References restarted.)*
...
From **MHLW “Basic Policy for Cyber-security Measures at Medical Facilities”**:
...
From **Guidelines on Safety Management of Healthcare Information Systems (Ver. 6.0 outline/major points)**:
...
### Health information systems most defensibly “in-scope / critical” (evidence-limited list)
...
*(Anything beyond these named examples—e.g., national eRx, national HIE, etc.—needs an explicit government source that names them as CI services/systems.)*

---

## References (Japan — restarted)

[1] Japanese Law Translation (Ministry of Justice). **The Basic Act on Cybersecurity (Act No. 104 of 2014)** (English translation).
[2] Cybersecurity Strategic Headquarters (Japan). **The Cybersecurity Policy for Critical Infrastructure Protection** (June 17, 2022; revised March 8, 2024) (English PDF).
[3] National Cybersecurity Office (Japan), **Critical Infrastructure Protection overview** (references the CIP policy and its measures).
[4] MHLW (Japan). **Basic Policy for Cyber-security Measures at Medical Facilities** (PDF you uploaded). 
[5] MHLW (Japan). **Guidelines on Safety Management of Healthcare Information Systems Ver. 6.0 — Outline and Major Points (Amended)** (PDF you uploaded). 
[6] PMDA/MHLW (Japan). **(English reference translation) Cybersecurity-related medical device safety / reporting material** (PDF you uploaded: 000272598.pdf). 

---

If you want, I can now do the same **“purely evidentiary re-issue”** treatment for **Germany** and **New Zealand**, with fresh references restarted for each country.
